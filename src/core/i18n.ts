...
const EN: Record<number, string> =
{
  ...
  16: "⚠️ Warning: Sync & Path Update (v0.2.2 ➔ v0.2.3)",
  ...
  //Agent Ai
  500: "Hello! I'm ",
  501: "Let’s naturally discuss your schedule. You can ask me to organize things or tell me about your priorities.",
  502: "Agent Configuration",
  503: "Customize your assistant and connect your AI provider.",
  504: "Warning",
  505: "Now, only the mistral AI models work.",
  ...
  511: "Template Name",
  512: "Key API",
  513: "Useless if you use a local LLM like Ollama",
  514: "Your API key...",
  515: "Agent Name",
  516: "Your name / username",
  517: "Save",
  518: "Cancel",
  519: "Settings",
  520: "Deadline:",
  ...
  531: "Archive",
  532: "Unarchive",
  533: "Talk to your agent or ask for a change...",
  534: "Send",
  535: "Current time:",
  536: "Error executing the agent action:",
  537: "Agent : Clé API manquante !",
  538: "Erreur : Clé API manquante.",
  539: "You are",
  540: "the user’s autonomous assistant",
  541: "Today we are the:",
  542: "You don’t have access to tasks by default. If the user asks you for information about their schedule, tasks, or todolist, you MUST use the 'searchTasks' tool to get the necessary information. Never guess the content of your todolist.",
  543: "Search for specific tasks in the TaskStore according to filters.",
  544: "Filter by status: false for in progress, true for completed (optional)",
  545: "Keyword to search in the title (optional)",
  546: "Create a new task",
  547: "YYYY-MM-DD format (optional)",
  548: "Edit an existing task.",
...
const FR: Partial<Record<number, string>> =
{
  ...
  //Agent AI
  500: "Bonjour ! Je suis ",
  501: "Discutons naturellement de votre emploi du temps. Vous pouvez me demander d'organiser des choses ou me parler de vos priorités.",
  502: "Configuration de l'agent",
  503: "Personnalisez votre assistant et connectez votre fournisseur d'IA.",
  504: "Avertissement",
  505: "Actuellement, seuls les modèles Mistral AI fonctionnent.",
  506: "Informations concernant la clé API",
  507: "Pour l'instant, seul le fournisseur Mistral fonctionne. Pour pouvoir l'utiliser gratuitement, vous devez créer un compte puis générer une clé API gratuite.",
  508: "Docs Mistral",
  509: "Fournisseur IA",
  510: "Choisissez le service à utiliser",
  511: "Nom du modèle",
  512: "Clé API",
  513: "Inutile si vous utilisez un LLM local comme Ollama",
  514: "Votre clé API...",
  515: "Nom de l'agent",
  516: "Votre nom / nom d'utilisateur",
  517: "Enregistrer",
  518: "Annuler",
  519: "Paramètres",
  520: "Date limite :",
  ...
  523: "Priorité :",
  524: "Modifier :",
  525: "Marquer comme terminée",
  526: "Remettre à faire",
  527: "Priorité ➔",
  528: "Date limite ➔",
  529: "Aucun(e)",
  530: "Renommer ➔",
  531: "Archiver",
  532: "Désarchiver",
  533: "Parlez à votre agent ou demandez une modification...",
  534: "Envoyer",
  535: "Heure actuelle :",
  536: "Erreur lors de l'exécution de l'action de l'agent :",
  537: "Agent : Clé API manquante !",
  538: "Erreur : Clé API manquante.",
  539: "Vous êtes",
  540: "l'assistant autonome de l'utilisateur",
  541: "Aujourd'hui nous sommes le :",
  542: "Vous n'avez pas accès aux tâches par défaut. Si l'utilisateur vous demande des informations sur son emploi du temps, ses tâches ou sa todolist, vous DEVEZ utiliser l'outil 'searchTasks' pour obtenir les informations nécessaires. Ne devinez jamais le contenu de sa todolist.",
  543: "Rechercher des tâches spécifiques dans le TaskStore selon des filtres.",
  544: "Filtrer par statut : false pour en cours, true pour terminée (optionnel)",
  545: "Mot-clé à rechercher dans le titre (optionnel)",
  546: "Créer une nouvelle tâche",
  547: "Format AAAA-MM-JJ (optionnel)",
  548: "Modifier une tâche existante.",
...
const ES: Partial<Record<number, string>> =
{
  ...
  //Agent ai
  500: "¡Hola! Soy ",
  501: "Hablemos de tu agenda de forma natural. Puedes pedirme que organice cosas o contarme tus prioridades.",
  502: "Configuración del agente",
  503: "Personaliza tu asistente y conecta tu proveedor de IA.",
  504: "Advertencia",
  505: "Por ahora, solo funcionan los modelos de Mistral AI.",
  506: "Información sobre la clave API",
  507: "Por ahora, solo funciona el proveedor Mistral. Para usarlo gratis, debes crear una cuenta y generar una clave API gratuita.",
  508: "Docs de Mistral",
  509: "Proveedor de IA",
  510: "Elige el servicio a utilizar",
  511: "Nombre del modelo",
  512: "Clave API",
  513: "Inútil si usas un LLM local como Ollama",
  514: "Tu clave API...",
  515: "Nombre del agente",
  516: "Tu nombre / nombre de usuario",
  517: "Guardar",
  518: "Cancelar",
  519: "Ajustes",
  520: "Fecha límite:",
  ...
  523: "Prioridad:",
  524: "Editar:",
  525: "Marcar como hecha",
  526: "Volver a poner pendiente",
  527: "Prioridad ➔",
  528: "Fecha límite ➔",
  529: "Ninguno",
  530: "Renombrar ➔",
  531: "Archivar",
  532: "Desarchivar",
  533: "Habla con tu agente o pide un cambio...",
  534: "Enviar",
  535: "Hora actual:",
  536: "Error al ejecutar la acción del agente:",
  537: "Agente: ¡Falta la clave API!",
  538: "Error: Falta la clave API.",
  539: "Eres",
  540: "el asistente autónomo del usuario",
  541: "Hoy estamos a:",
  542: "No tienes acceso a las tareas por defecto. Si el usuario te pide información sobre su agenda, tareas o lista de pendientes, DEBES usar la herramienta 'searchTasks' para obtener la información necesaria. Nunca adivines el contenido de su lista.",
  543: "Buscar tareas específicas en el TaskStore según los filtros.",
  544: "Filtrar por estado: false para en progreso, true para completada (opcional)",
  545: "Palabra clave para buscar en el título (opcional)",
  546: "Crear una nueva tarea",
  547: "Formato AAAA-MM-DD (opcional)",
  548: "Editar una tarea existente.",
  549: "Eliminar permanentemente una tarea del sistema.",
...
const DE: Record<number, string> =
{
  ...
  500: "Hallo! Ich bin ",
  501: "Lass uns ganz entspannt über deinen Zeitplan sprechen. Du kannst mich bitten, Dinge zu organisieren, oder mir deine Prioritäten mitteilen.",
  502: "Agenten-Konfiguration",
  503: "Passe deinen Assistenten an und verbinde deinen KI-Anbieter.",
  504: "Warnung",
  505: "Derzeit funktionieren nur die Mistral AI-Modelle.",
  506: "Informationen zum API-Schlüssel",
  507: "Vorerst funktioniert nur der Anbieter Mistral. Um ihn kostenlos zu nutzen, musst du ein Konto erstellen und einen kostenlosen API-Schlüssel generieren.",
  508: "Mistral-Doku",
  509: "KI-Anbieter",
  510: "Wähle den zu verwendenden Dienst",
  511: "Modellname",
  512: "API-Schlüssel",
  513: "Nicht erforderlich, wenn du ein lokales LLM wie Ollama verwendest",
  514: "Dein API-Schlüssel...",
  515: "Agentenname",
  516: "Dein Name / Benutzername",
  517: "Speichern",
  518: "Abbrechen",
  519: "Einstellungen",
  520: "Frist:",
  ...
  523: "Priorität:",
  524: "Bearbeiten:",
  525: "Als erledigt markieren",
  526: "Wieder auf 'Zu erledigen' setzen",
  527: "Priorität ➔",
  528: "Frist ➔",
  529: "Keine",
  530: "Umbenennen ➔",
  531: "Archivieren",
  532: "Demarkieren",
  533: "Sprich mit deinem Agenten oder fordere eine Änderung an...",
  534: "Senden",
  535: "Aktuelle Uhrzeit:",
  536: "Fehler bei der Ausführung der Agenten-Aktion:",
  537: "Agent: API-Schlüssel fehlt!",
  538: "Fehler: API-Schlüssel fehlt.",
  539: "Du bist",
  540: "der autonome Assistent des Benutzers",
  541: "Heute haben wir den:",
  542: "Du hast standardmäßig keinen Zugriff auf Aufgaben. Wenn der Benutzer dich nach Informationen zu seinem Zeitplan, seinen Aufgaben oder seiner To-Do-Liste fragt, MUSST du das Tool 'searchTasks' verwenden, um die erforderlichen Informationen zu erhalten. Rate niemals den Inhalt der To-Do-Liste.",
  543: "Suche nach bestimmten Aufgaben im TaskStore anhand von Filtern.",
  544: "Nach Status filtern: false für in Bearbeitung, true für abgeschlossen (optional)",
  545: "Schlüsselwort für die Suche im Titel (optional)",
  546: "Eine neue Aufgabe erstellen",
  547: "Format JJJJ-MM-TT (optional)",
  548: "Eine bestehende Aufgabe bearbeiten.",
